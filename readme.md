...
PixelShot is an awesome Android library that can save any `View` or `SurfaceView` as an image in the formats JPG/PNG/nomedia. The library works on a asynchronous task behind the scenes and handles errors of I/O operations and memory handling for you.
